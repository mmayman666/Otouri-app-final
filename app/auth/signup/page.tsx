...
const translations = {
  ar: {
    ...
    signupSubtitle: "انضم إلينا واكتشف عالم العطور المثالي لك",
    name: "الاسم",
    ...
    passwordHint: "يجب أن تحتوي كلمة المرور على 8 أحرف على الأقل وتتضمن حرفًا كبيرًا ورقمًا",
    signupButton: "إنشاء حساب",
    signupButtonLoading: "جاري إنشاء الحساب...",
  ...
  en: {
    ...
    signupSubtitle: "Join us and discover the perfect world of perfumes for you",
    name: "Name",
    ...
    passwordHint: "Password must contain at least 8 characters including uppercase letter and number",
    signupButton: "Create Account",
    signupButtonLoading: "Creating account...",
    orSignupWith: "Or create account with",
    google: "Google",
    twitter: "X (Twitter)",
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        window.location.href = `/auth/error?message=${encodeURIComponent("خطأ في تسجيل الدخول بـ Google. يرجى المحاولة مرة أخرى.")}`
      }
    } catch (error) {
      console.error("Google signup error:", error)
      window.location.href = `/auth/error?message=${encodeURIComponent("خطأ في تسجيل الدخول بـ Google. يرجى المحاولة مرة أخرى.")}`
  ...
  const handleTwitterSignup = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        window.location.href = `/auth/error?message=${encodeURIComponent("خطأ في تسجيل الدخول بـ X (Twitter). يرجى المحاولة مرة أخرى.")}`
      }
    } catch (error) {
      console.error("Twitter signup error:", error)
      window.location.href = `/auth/error?message=${encodeURIComponent("خطأ في تسجيل الدخول بـ X (Twitter). يرجى المحاولة مرة أخرى.")}`
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-sage-100">
          <div className="p-8">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-sage-900 mt-6 mb-2">{t.signupTitle}</h2>
